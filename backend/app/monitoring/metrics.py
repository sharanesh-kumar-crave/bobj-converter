...
class MetricsCollector:
    ...
    async def record_job_completed(
        self, job_id: str, duration_s: float, total_objects: int, converted: int
    ):
        async with self._lock:
        ...
        logger.info(
            ...
            extra={
                ...
                "converted": converted,
                "conversion_rate": round(converted / total_objects * 100, 1)
                if total_objects
                else 0,
            },
        )
            ...
            return {
                ...
                "datasphere": {
                    ...
                    "success_rate_pct": round(
                        self.ds_pushes_ok / (self.ds_pushes_ok + self.ds_pushes_fail + 0.001) * 100,
                        1,
                    ),
                },
                "sac": {
